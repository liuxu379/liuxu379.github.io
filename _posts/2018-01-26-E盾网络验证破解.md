...
![Exeinfo PE 检测到 UPX 壳]({{site.url}}/img/post-img-exe-1.png?raw=true)

然后提取 DLL文件，用 Ollydbg 加载 DLL，没有壳的话可以直接加载 exe 主程序。
![OllyDbg 加载 DLL 文件]({{site.url}}/img/post-img-exe-2.png?raw=true)
...
![搜索暗桩二进制特征码]({{site.url}}/img/post-img-exe-3.png?raw=true)
...
![定位暗桩调用位置]({{site.url}}/img/post-img-exe-4.png?raw=true)
...
![修改跳转逻辑去除暗桩]({{site.url}}/img/post-img-exe-5.png?raw=true)
